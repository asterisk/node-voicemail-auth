 ...
 */
function fsm(channel, dependencies) {
 ...
 */
function createAuthenticator(channel, dependencies) {
  var state = fsm(channel, dependencies);
...
module.exports = function(dependencies) {
  return {
    create: function(channel) {
      return createAuthenticator(channel, dependencies);
    }
  };
};
